...
@Service
public class AASlanjeMVDoradeService implements JavaDelegate{
	@Autowired
	...
	public void sendNotificaitionAsync(Korisnik k, String processInstanceId) throws MailException, InterruptedException, MessagingException {
		...
		String htmlMsg = "<h3>Pozdrav "+k.getIme()+",</h3><br> <p>Obavestavamo Vas da je Vas poslat na manju ili vecu doradu!</p>";
		mimeMessage.setContent(htmlMsg, "text/html");
		helper.setTo(k.getEmail());
		helper.setSubject("Obavestenje o slanju rada na manje/vece dorade");
