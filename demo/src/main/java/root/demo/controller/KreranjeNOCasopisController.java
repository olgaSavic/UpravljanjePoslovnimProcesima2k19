...
@Controller
@RequestMapping("/noCasopisController")
public class KreranjeNOCasopisController {
    ...
    public @ResponseBody ResponseEntity posaljiNO(@RequestBody List<FormSubmissonDTO> dto, @PathVariable String taskId) {
		...
		runtimeService.setVariable(processInstanceId, "naucnaOblastCasopis", dto);
